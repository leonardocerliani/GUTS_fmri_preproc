...
# THESE COMMANDS WILL STOP ANY CURRENTLY RUNNING FEAT PROCESS
# AND DELETE THE EXISTING .FEAT DIRECTORIES !!!
# ALL OF YOUR WORK COULD BE LOST. THEREFORE THEY ARE COMMENTED BY DEFAULT
#
#############################################################################
